...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        mirroring_group.add_argument("--eliminate-dir-links", action=BooleanOptionalAction, default=True, help="delete symlinks to directories in DEST in advance so that it prevents deleting files outside of the DEST directory tree")
